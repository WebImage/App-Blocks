...
/**
 * Tqken directly from Doctrine with modifications as needed
 */
...
abstract class AbstractLexer
{
     ...
     *
     * @param UnitEnum $type The token type to skip until.
     *
     * @return void
     */
    ...
    public function peekBehind(): ?Token
    {
        if ($this->peek > -2) $this->peek = -2;
        if (isset($this->tokens[$this->position + $this->peek - 1])) {
            return $this->tokens[$this->position + --$this->peek];
        }
